<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($amt<=0) {
            ...
            if (!$set2) {
                //direct error use krne pe bug aa rha h
...
<head>
    ...
    <style>
        .trans__from {
            width: 700px;
            height: 600px;
            background: linear-gradient(90deg, rgb(29, 245, 238) 6%, rgba(235,242,242,1) 83%);
            margin-top: 20px;
...
<body onload="load()">
    ...
    <header>
        ...
        <?php
            ...
            if ($note3==true) {
                echo'<br><br>';
                echo "<h1 align='center' style='color:rgb(15, 115, 112);'>Congrats!! Transaction Successful</h1>";
                echo"<br>";
                echo "<h1 align='center' style='color:rgb(15, 115, 112);'>{$sql5['name']}'s Updated Balance:{$sql5['balance']} </h1>";
                echo"<br>";
